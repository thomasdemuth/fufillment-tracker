...
export function TagPicker({ shipment }: { shipment: ShipmentDetail }) {
  ...
  return (
    <section>
      <h3 className="mb-1.5 text-xs font-semibold uppercase tracking-wide text-muted">Tags</h3>
        ...
        {adding ? (
          <div className="relative">
            ...
            {suggestions.length > 0 && (
              <div className="absolute left-0 top-8 z-20 w-40 rounded-md border border-border bg-panel p-1 shadow-lg">
